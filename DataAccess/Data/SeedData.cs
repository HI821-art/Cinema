...
new Session
{
    ...
    {
        SeatNumber = i.ToString(),
        IsBooked = false // All seats available
    }).ToList()
},
new Session
{
...
new Session
{
    StartTime = DateTime.Now.AddHours(16),
    Movie = movies[15],
    Seats = Enumerable.Range(1, 50).Select(i => new Seat
    {
        SeatNumber = i.ToString(),
...
new Session
{
    StartTime = DateTime.Now.AddHours(19),
    Movie = movies[18],
    Seats = Enumerable.Range(1, 50).Select(i => new Seat
    {
        SeatNumber = i.ToString(),
...
new Session
{
    StartTime = DateTime.Now.AddHours(26),
    Movie = movies[25],
    Seats = Enumerable.Range(1, 50).Select(i => new Seat
    {
        SeatNumber = i.ToString(),
...
new Session
{
    StartTime = DateTime.Now.AddHours(28),
    Movie = movies[27],
    Seats = Enumerable.Range(1, 50).Select(i => new Seat
    {
        SeatNumber = i.ToString(),
...
new Session
{
    StartTime = DateTime.Now.AddHours(29),
    Movie = movies[28],
    Seats = Enumerable.Range(1, 50).Select(i => new Seat
    {
        SeatNumber = i.ToString(),
